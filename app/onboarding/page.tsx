          ...
          {step === 2 && (
            <div className="space-y-6">
              <div>
                ...
                <select
                  value={formData.goal}
                  onChange={(e) => handleFieldChange('goal', e.target.value as 'loss' | 'maintain' | 'gain')}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleFieldChange('activity', e.target.value as 'sedentary' | 'light' | 'moderate' | 'very' | 'extra')}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                >
            ...
            <div className="space-y-6">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleFieldChange('dietType', e.target.value as 'veg' | 'non-veg' | 'vegan' | 'jain' | 'maharashtrian')}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                >
